...
<div style="color:white; font-family:Arial; font-size:30px;">
  <?php
   echo "Name: " . $row["firstname"] . " " . $row["lastname"]. "<br><br>"."Email ID: ".$row["email"]. "<br><br>"."Phone number: " . $row["pno"]. "<br><br>"."Aadhar Number: " . $row["ano"]. "<br><br>"."PAN Number: " . $row["pan"]. "<br><br>"."GSTIN: " . $row["gst"]."<br/><br>"."Gender: " . $row["gender"] ."<br/><br>"."Policy: " . $row["pol"];
  ?>
</div>
</div>
